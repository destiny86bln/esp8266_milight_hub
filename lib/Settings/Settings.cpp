...
void Settings::patch(JsonObject& parsedSettings) {
  if (parsedSettings.success()) {
    ...
    this->setIfPresent(parsedSettings, "mqtt_pin_1", mqttPin1);
    this->setIfPresent(parsedSettings, "mqtt_pin_2", mqttPin2);
    this->setIfPresent(parsedSettings, "mqtt_pin_3", mqttPin3);
    this->setIfPresent(parsedSettings, "mqtt_pin_4", mqttPin4);
...
void Settings::serialize(Stream& stream, const bool prettyPrint) {
  ...
  root["mqtt_pin_1"] = this->mqttPin1;
  root["mqtt_pin_2"] = this->mqttPin2;
  root["mqtt_pin_3"] = this->mqttPin3;
  root["mqtt_pin_4"] = this->mqttPin4;
